...
<head>
    ...
    <script type="text/javascript"
            src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.21/b-1.6.2/b-html5-1.6.2/b-print-1.6.2/datatables.min.js"></script>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr id="<?php echo $row["id"]; ?>">
                ...
                <td>
                    ...
                    <a href="#deleteModal" class="delete" data-id="<?php echo $row["id"]; ?>" data-toggle="modal"><i
    ...
    <table class="table table-striped table-hover" id="table-filtered">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr id="<?php echo $row["id"]; ?>">
                ...
                <td><?php echo $row["postos"]; ?></td>
                <td>
                    <a href="#" id="renew" data-id="<?php echo $row["id"]; ?>">
                        <i class="material-icons" data-toggle="tooltip" title="Renovar">done</i></a>
                </td>
                <td>
                    <a href="#" id="cancel" data-id="<?php echo $row["id"]; ?>">
